...
__all__ = [
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SPEAudioSizeTime',
    'DISPID_SRCRetainedAudioFormat', 'SRADefaultToActive',
    'SREPhraseStart', 'DISPIDSPTSI', 'SVSFPersistXML', 'SGSExclusive',
    'STSF_LocalAppData', 'DISPID_SRGCmdLoadFromMemory',
    'SPEI_RECO_OTHER_CONTEXT', 'SPEVENT', 'DISPID_SRRGetXMLResult',
    'SPEI_PHRASE_START', 'DISPID_SGRClear',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SPELexicalForm',
    'SAFT11kHz8BitMono', 'ISpeechObjectTokenCategory',
    'SpUnCompressedLexicon', 'SINoSignal', 'DISPID_SLPPhoneIds',
    'eLEXTYPE_PRIVATE14', 'DISPID_SGRsItem', 'DISPID_SPILanguageId',
    'SPAO_NONE', 'SpeechTokenKeyFiles', 'SREFalseRecognition',
    'DISPID_SpeechGrammarRules', 'ISpeechLexiconWords', 'SPWF_INPUT',
    'DISPID_SOTId', 'SPSHORTCUTTYPE', 'SSFMOpenForRead',
    'SAFTCCITT_ALaw_44kHzMono', 'SVSFIsFilename',
    'DISPID_SOTGetStorageFileName', 'SAFT22kHz8BitStereo', 'SDTRule',
    'DISPID_SpeechObjectTokens', 'SVP_2', 'ISpXMLRecoResult',
    'SAFTGSM610_11kHzMono', 'DISPID_SWFEBitsPerSample',
    'SpeechTokenKeyAttributes', 'SECFIgnoreKanaType',
    'eLEXTYPE_PRIVATE8', 'SPSHORTCUTPAIR', 'DISPID_SGRsFindRule',
    ...
    'eLEXTYPE_PRIVATE20', 'DISPID_SPEsItem', 'STSF_FlagCreate',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SPPNumberOfElements', 'SPVISEMES', 'DISPID_SPCIdToPhone',
    'SVP_4', 'ISpeechPhraseReplacements', 'SPEI_REQUEST_UI',
    'ISpeechGrammarRuleStateTransitions', 'SAFT12kHz8BitStereo',
    'SGDSInactive', 'ISpEventSource', 'SPPS_RESERVED2',
    'SPSSuppressWord', 'SVSFlagsAsync', 'DISPID_SVPause',
    'SPSTREAMFORMATTYPE', 'SDA_Two_Trailing_Spaces',
    'ISpeechPhraseReplacement', 'DISPID_SMSAMMHandle',
    'ISpRecognizer2', 'SRATopLevel', 'DISPID_SGRSTType',
    'SP_VISEME_9', 'SPPS_Unknown', 'SpeechTokenValueCLSID',
    'DISPID_SPRulesItem', 'SP_VISEME_8', 'SPRS_ACTIVE_USER_DELIMITED',
    'SFTSREngine', 'eLEXTYPE_PRIVATE16', 'SpeechLexiconType',
    'DISPID_SGRSTWeight', 'eLEXTYPE_RESERVED9',
    '__MIDL_IWinTypes_0009', 'LONG_PTR', 'DISPID_SOTCId',
    'SPINTERFERENCE_TOOFAST', 'SpShortcut', 'SPAS_PAUSE',
    'SGRSTTDictation', 'ISpResourceManager', 'ISpeechLexicon',
    'DISPID_SPIRule', 'SpResourceManager', 'DISPID_SPEsCount',
    'SP_VISEME_11', 'SAFTDefault', 'SpeechDataKeyLocation',
    'SAFTCCITT_ALaw_44kHzStereo', 'SpMMAudioEnum',
    'DISPID_SRCEEndStream', 'DISPID_SLPPartOfSpeech',
    'ISpeechFileStream', 'DISPID_SPRuleName', 'DISPID_SPPConfidence',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SAFT44kHz16BitMono',
    'SpeechFormatType', 'ISpeechPhraseAlternates',
    'ISpeechCustomStream', 'SPPHRASE', 'SP_VISEME_4',
    'DISPID_SPRuleChildren', 'SpeechRuleAttributes',
    'SPEI_SR_BOOKMARK', 'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SRState',
    'ISpGrammarBuilder', 'SRAONone',
    'DISPID_SPPBRestorePhraseFromMemory', 'SREPrivate',
    'SAFTGSM610_8kHzMono', 'DISPID_SRRSetTextFeedback',
    'DISPID_SpeechRecoResult2', 'SGDisplay', 'DISPID_SPCPhoneToId',
    'SPSModifier', 'DISPID_SRCEHypothesis', 'SPRST_NUM_STATES',
    'SAFT32kHz8BitMono', 'SSFMOpenReadWrite', 'SpMemoryStream',
    'DISPIDSPTSI_SelectionOffset', 'SITooLoud', 'ISpShortcut',
    'SPRS_ACTIVE', 'SpeechVoiceEvents', 'SPEI_PHONEME',
    'SPCT_SUB_DICTATION', 'DISPID_SGRSTText', 'SECHighConfidence',
    'SAFT24kHz8BitMono', 'DISPID_SVEventInterests',
    'DISPID_SRGDictationLoad', 'SPAS_RUN', 'SPEI_TTS_BOOKMARK',
    'SVEPhoneme', 'DISPID_SRCESoundStart', 'eLEXTYPE_PRIVATE9',
    'DISPID_SDKGetlongValue', 'SPEI_RESERVED2', 'SPSLMA',
    'DISPID_SVIsUISupported', 'SSSPTRelativeToStart',
    'DISPID_SOTDisplayUI', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SDKDeleteKey', 'SPEI_SOUND_END', 'SPRECORESULTTIMES',
    'SREPropertyNumChange', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SOTCSetId', 'ISpeechRecognizer', 'DISPID_SCSBaseStream',
    'SVEAllEvents', 'DISPID_SLWsCount', 'DISPID_SPPValue',
    'SPAO_RETAIN_AUDIO', 'SP_VISEME_16', 'SpeechRunState',
    'DISPID_SPAStartElementInResult', 'SpeechWordType',
    'DISPID_SASCurrentDevicePosition', 'SPSHT_Unknown',
    'DISPID_SRSClsidEngine', 'DISPID_SVEBookmark', 'SRTAutopause',
    ...
    'DISPID_SVStatus', 'SAFTCCITT_ALaw_11kHzMono', 'SGRSTTEpsilon',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SVSVisemeId',
    'DISPID_SRCreateRecoContext', 'SPFM_CREATE', 'SRCS_Disabled',
    'SDKLLocalMachine', 'ISpeechMMSysAudio', 'SPBO_TIME_UNITS',
    'SPAUDIOOPTIONS', 'eLEXTYPE_RESERVED4', 'SPWORDPRONUNCIATION',
    'DISPID_SRStatus', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SAFGuid', 'SpMMAudioIn',
    'SGDSActiveUserDelimited', 'SpeechAudioVolume', 'SPLOADOPTIONS',
    'SASStop', 'SAFT11kHz16BitMono', 'SRERecoOtherContext',
    'SPPHRASEELEMENT', 'DISPID_SPRFirstElement',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFTADPCM_11kHzMono',
    'SPCT_SUB_COMMAND', 'SP_VISEME_0', 'SVEBookmark',
    'DISPID_SVVoice', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'SRTExtendableParse', 'SRTStandard', 'DISPID_SABIBufferSize',
    'SAFT8kHz16BitStereo', 'DISPID_SVEStreamEnd',
    'ISpeechLexiconPronunciations', 'SRESoundStart', 'DISPID_SLWWord',
    'SPVPRI_OVER', 'ISpeechGrammarRuleStateTransition',
    'SDKLDefaultLocation', 'SINoise', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SLGetPronunciations', 'eLEXTYPE_VENDORLEXICON',
    'ISpDataKey', 'SP_VISEME_14', 'eLEXTYPE_PRIVATE18',
    'SpeechDisplayAttributes', 'DISPID_SLGetWords',
    'DISPID_SRRecognizer', 'SRSInactive',
    'DISPID_SPRDisplayAttributes', 'SVP_5', 'SAFT11kHz16BitStereo',
    'DISPID_SPEPronunciation', 'SAFTTrueSpeech_8kHz1BitMono',
    'SREAudioLevel', 'SpSharedRecoContext', 'SPEI_INTERFERENCE',
    'SVP_17', 'SpeechGrammarWordType', 'SPDKL_CurrentUser',
    'SPPS_RESERVED4', 'DISPID_SVAlertBoundary', 'ISpeechObjectToken',
    'eLEXTYPE_PRIVATE1', 'SPWT_PRONUNCIATION',
    'DISPID_SVSLastBookmarkId', 'ISpProperties', 'SPSFunction',
    'SPEI_START_SR_STREAM', 'ISpSerializeState',
    'tagSPTEXTSELECTIONINFO', 'ISpeechPhraseProperties',
    'DISPID_SpeechPhraseRules', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SWFEAvgBytesPerSec', 'SPCS_ENABLED', 'DISPID_SRCPause',
    'ISpRecoContext', 'ISpEventSink', 'eLEXTYPE_RESERVED6', 'SVP_10',
    'SVEPrivate', 'DISPID_SPIGrammarId', 'DISPID_SPPEngineConfidence',
    'SVF_Stressed', 'SREStreamEnd', 'DISPID_SAFGetWaveFormatEx',
    'Speech_Max_Pron_Length', 'SPEI_PROPERTY_NUM_CHANGE',
    'SDTProperty', 'SPBINARYGRAMMAR', 'ISequentialStream',
    'SPPS_SuppressWord', 'SPFM_CREATE_ALWAYS', 'DISPID_SLPType',
    'SpPhraseInfoBuilder', 'SRCS_Enabled', 'SpeechEngineProperties',
    'DISPID_SRGDictationUnload', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SRCRetainedAudio', 'SpeechRegistryUserRoot', 'SPSUnknown',
    'SPVPRI_ALERT', 'DISPID_SBSWrite', 'DISPID_SRGCommit',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRAudioInput', 'SLTUser',
    'DISPID_SPIAudioSizeBytes', 'SPFM_OPEN_READONLY',
    'DISPID_SGRsAdd', 'DISPID_SpeechBaseStream', 'SpeechRecoEvents',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechLexiconWords',
    'DISPID_SpeechPhraseReplacements', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFTADPCM_11kHzStereo', 'SDKLCurrentConfig',
    'DISPID_SRCEEnginePrivate', 'SPPS_Noncontent',
    'eLEXTYPE_PRIVATE10', 'SpeechCategoryRecognizers',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SDKGetBinaryValue', 'ISpVoice', 'DISPID_SOTCategory',
    '_ISpeechRecoContextEvents', 'SVP_6', 'Speech_Max_Word_Length',
    'SP_VISEME_17', 'SVP_7', 'SVEViseme', 'SPLO_DYNAMIC',
    'SPPHRASEPROPERTY', 'SDTPronunciation', 'SPGRAMMARSTATE',
    'DISPID_SRGetRecognizers', 'SPSEMANTICFORMAT',
    'SPADAPTATIONRELEVANCE', 'SP_VISEME_5', 'SDTAudio',
    'DISPID_SGRSTRule', 'DISPID_SVSLastStreamNumberQueued',
    'ISpNotifySink', 'SPPS_Noun', 'DISPID_SGRAddResource',
    'DISPID_SVSPhonemeId', 'DISPID_SGRSTNextState', 'DISPID_SFSClose',
    'SVSFNLPMask', 'SPDATAKEYLOCATION', 'SGDSActiveWithAutoPause',
    'SAFTADPCM_22kHzStereo', 'ISpStreamFormat', 'SDTReplacement',
    'DISPID_SPRulesCount', 'DISPID_SpeechRecognizer',
    'DISPID_SRCEInterference', 'STCAll', 'SP_VISEME_2',
    'ISpObjectTokenCategory', 'DISPID_SRSAudioStatus',
    'ISpeechPhraseRule', 'DISPID_SRGId', 'SPWORDPRONUNCIATIONLIST',
    'SAFT32kHz16BitStereo', 'DISPID_SRCCmdMaxAlternates',
    'SPEI_RESERVED6', 'ISpeechPhraseProperty', 'SVP_16',
    'ISpeechPhoneConverter', 'SAFT24kHz8BitStereo', 'SPEI_UNDEFINED',
    'SGDSActive', 'eLEXTYPE_PRIVATE11', 'DISPID_SPAsItem',
    'ISpRecognizer', 'SpeechCategoryRecoProfiles', 'SRESoundEnd',
    'DISPID_SRSCurrentStreamNumber', 'SRSActive',
    'DISPID_SRGCmdSetRuleIdState', 'eLEXTYPE_USER',
    'ISpeechRecoResult', 'DISPID_SLPSymbolic', 'SPWORDTYPE',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SVEEnginePrivate',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SREStreamStart',
    'SITooFast', 'SPAS_CLOSED', 'SGRSTTTextBuffer',
    'DISPID_SpeechPhraseElements', 'ISpeechPhraseInfoBuilder',
    'ISpeechGrammarRules', 'SPPARTOFSPEECH', 'ISpeechWaveFormatEx',
    'SpeechRegistryLocalMachineRoot', 'ISpPhraseAlt',
    'DISPID_SpeechGrammarRule', 'SPPROPERTYINFO', 'SVSFUnusedFlags',
    'DISPID_SLWPronunciations', 'DISPID_SMSSetData',
    'SRAORetainAudio', 'SPEI_END_INPUT_STREAM',
    'DISPID_SGRSAddSpecialTransition', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPPName', 'SREInterference', 'DISPID_SRGetPropertyNumber',
    'STCInprocHandler', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRCVoice', 'SpeechUserTraining', 'SPAR_High',
    'DISPID_SRGCmdSetRuleState', 'SVP_11',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SASetState',
    'DISPID_SPEAudioSizeBytes', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRGRecoContext',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SGRsCommit',
    'DISPID_SRRAudio', 'SpeechRecognitionType', 'SPEI_MIN_TTS',
    'SPDKL_DefaultLocation',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SLRemovePronunciation', 'DISPID_SBSFormat',
    'SAFTGSM610_22kHzMono', 'SpeechTokenKeyUI', 'SVP_18',
    'SAFTADPCM_44kHzMono', 'SpInProcRecoContext',
    'SpeechRecoProfileProperties', 'SITooQuiet',
    'DISPID_SpeechFileStream', 'ISpeechRecognizerStatus', 'SVPAlert',
    'SPEI_RECO_STATE_CHANGE', 'eLEXTYPE_RESERVED10', 'ISpMMSysAudio',
    'SpeechVisemeFeature', 'ISpeechXMLRecoResult',
    'eLEXTYPE_PRIVATE7', 'ISpObjectToken',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SRProfile', '_ISpeechVoiceEvents',
    'DISPID_SPEDisplayText', 'SLOStatic', 'DISPID_SPRuleId',
    'SPAUDIOSTATUS', 'SpeechAudioFormatGUIDWave',
    'DISPID_SABufferNotifySize', 'SpeechStreamFileMode',
    'IEnumSpObjectTokens', 'DISPID_SGRSAddRuleTransition',
    'SVSFIsXML', 'DISPID_SPIAudioStreamPosition',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPINTERFERENCE_TOOSLOW',
    'ISpLexicon', 'SpeechVoicePriority', 'SP_VISEME_13',
    'SAFTExtendedAudioFormat', 'DISPID_SGRSTransitions',
    'DISPID_SOTCreateInstance', 'SpeechDictationTopicSpelling',
    'DISPID_SOTMatchesAttributes', 'SP_VISEME_18',
    'DISPID_SRCEBookmark', 'DISPID_SRRAudioFormat', 'SPAR_Medium',
    'ISpObjectWithToken', 'DISPID_SGRSRule', 'DISPID_SPPId',
    'SPGRAMMARWORDTYPE', 'DISPID_SPRNumberOfElements',
    'ISpeechMemoryStream', 'DISPID_SpeechPhraseElement',
    'DISPID_SABIEventBias', 'DISPID_SRCEStartStream',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SVRate', 'SP_VISEME_20',
    'SITooSlow', 'SpeechPropertyAdaptationOn', 'SECFIgnoreWidth',
    'ISpeechRecoResultTimes', 'SECFEmulateResult', 'DISPID_SVVolume',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SpeechVoice',
    'DISPID_SVEVoiceChange', 'DISPID_SWFEFormatTag', 'SPRST_ACTIVE',
    'SPVOICESTATUS', 'SGRSTTWildcard', 'SRTSMLTimeout',
    'SAFT16kHz8BitStereo', 'SAFT22kHz16BitStereo',
    'ISpeechPhraseAlternate', 'SPWT_DISPLAY', 'SVP_8',
    'DISPID_SVESentenceBoundary', 'DISPID_SLGetGenerationChange',
    'DISPID_SVEAudioLevel', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPEI_SENTENCE_BOUNDARY', 'SPEI_RESERVED3', 'SVP_3', 'SPWORD',
    'SP_VISEME_21', 'SAFT12kHz8BitMono', 'DISPID_SRGSetTextSelection',
    'SPCS_DISABLED', 'DISPID_SRCEAdaptation', 'SPEI_MIN_SR',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SVSLastResult',
    'ISpeechGrammarRule', 'SPEI_VOICE_CHANGE', 'DISPID_SRDisplayUI',
    'SpeechMicTraining', 'DISPID_SRGetFormat', 'SPCATEGORYTYPE',
    'SAFT8kHz16BitMono', 'ISpRecoGrammar2', 'DISPID_SAVolume',
    'DISPID_SABIMinNotification', 'SpVoice', 'SpCustomStream',
    'DISPID_SAStatus', 'DISPID_SADefaultFormat',
    'SpeechBookmarkOptions', 'SpeechGrammarTagDictation', 'SVPOver',
    'SPSNotOverriden', 'STCRemoteServer', 'UINT_PTR',
    'ISpeechBaseStream', 'SVSFDefault', 'DISPID_SPEEngineConfidence',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SAFT24kHz16BitMono',
    'SpeechTokenIdUserLexicon', 'DISPID_SpeechVoiceStatus',
    'SAFT12kHz16BitStereo', 'SPSERIALIZEDPHRASE', 'SVEEndInputStream',
    'SPEVENTENUM', 'eWORDTYPE_DELETED',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SGRsCommitAndSave',
    'ISpeechVoiceStatus', 'DISPID_SVEStreamStart',
    'DISPID_SPIRetainedSizeBytes', 'SVP_9', 'SP_VISEME_1',
    'DISPID_SpeechAudio', 'SPSNoun', 'SPRST_INACTIVE_WITH_PURGE',
    'eLEXTYPE_PRIVATE17', 'SVP_19', 'DISPID_SOTGetAttribute',
    'SDA_No_Trailing_Space', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPRECOGNIZERSTATUS', 'DISPID_SRCRequestedUIType', 'SASRun',
    'SP_VISEME_6', 'IStream', 'SPSHORTCUTPAIRLIST',
    'SPXRO_Alternates_SML', 'DISPID_SPPsCount', 'SAFT44kHz8BitMono',
    'SPEI_MAX_TTS', 'SPINTERFERENCE_NOISE', 'SpeechLoadOption',
    'DISPID_SWFEChannels', 'ISpRecoCategory', 'DISPID_SPARecoResult',
    'SpeechCategoryVoices', 'SSTTWildcard', 'SAFT48kHz8BitStereo',
    'SVP_20', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'ISpStream',
    'DISPID_SDKSetLongValue', 'DISPID_SPRs_NewEnum',
    'ISpeechTextSelectionInformation', 'SPEI_VISEME',
    'DISPID_SRSetPropertyNumber', 'DISPID_SPRuleEngineConfidence',
    'SVSFParseSapi', 'SAFTCCITT_uLaw_22kHzMono',
    'DISPID_SpeechRecoResult', 'SAFTADPCM_8kHzMono',
    'DISPID_SOTDataKey', 'ISpRecoResult', 'DISPID_SASFreeBufferSpace',
    'SPAUDIOSTATE', 'eLEXTYPE_PRIVATE19', 'ISpeechRecoGrammar',
    'eLEXTYPE_RESERVED7', 'STSF_CommonAppData', 'ISpRecoGrammar',
    'SVP_12', 'SVP_13', 'SpFileStream', 'SpeechTokenShellFolder',
    'SPAR_Unknown', 'SpeechAudioState', 'SpStream',
    'DISPID_SpeechLexicon', 'SRSActiveAlways', 'DISPID_SPPParent',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SpeechPhoneConverter', 'STCLocalServer', 'SPWORDLIST',
    'SVEWordBoundary', 'SECFIgnoreCase', 'SAFTNonStandardFormat',
    'eLEXTYPE_MORPHOLOGY', 'SpMMAudioOut',
    'DISPID_SRGCmdLoadFromFile', 'SPSHT_NotOverriden',
    'DISPID_SPACommit', 'SpeechPartOfSpeech', 'SSTTDictation',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIAudioSizeTime', 'IInternetSecurityManager',
    'DISPID_SPANumberOfElementsInResult',
    'DISPID_SpeechPhraseProperties', 'SPWAVEFORMATTYPE',
    'ISpeechGrammarRuleState', 'SPBO_AHEAD', 'DISPID_SRCERecognition',
    'SPFILEMODE', 'SPPS_RESERVED3', 'STCInprocServer',
    'DISPID_SpeechDataKey', '_RemotableHandle', 'SVEVoiceChange',
    'DISPID_SLPs_NewEnum', 'SRSEIsSpeaking',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SAFType',
    'SpeechAudioProperties', 'DISPID_SPIGetDisplayAttributes',
    'SPAUDIOBUFFERINFO', 'ISpeechAudio', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SpeechAudioStatus', 'SDA_Consume_Leading_Spaces',
    'SPINTERFERENCE_NONE', 'DISPID_SRSSupportedLanguages',
    'DISPID_SDKCreateKey', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SGRsDynamic', 'Speech_StreamPos_RealTime',
    'SAFT48kHz16BitStereo', 'SRADynamic', 'SPINTERFERENCE',
    'ISpeechAudioBufferInfo', 'SWPKnownWordPronounceable',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPEActualConfidence',
    'DISPID_SpeechLexiconWord', 'SpPhoneticAlphabetConverter',
    'SLODynamic', 'SpeechAllElements', 'SRSInactiveWithPurge',
    'DISPID_SVSpeakStream', 'SAFT8kHz8BitStereo',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SDKGetStringValue',
    'ISpeechPhraseRules', 'SAFT32kHz8BitStereo', 'SDTDisplayText',
    'DISPID_SPERequiredConfidence', '_SPAUDIOSTATE',
    'DISPID_SRGState', 'ISpStreamFormatConverter',
    'SpeechWordPronounceable', 'SAFT12kHz16BitMono', 'SDTLexicalForm',
    'Speech_Default_Weight', 'SpStreamFormatConverter',
    'DISPID_SPPFirstElement', 'SPWF_SRENGINE',
    'DISPID_SLAddPronunciation', 'SpeechCategoryAudioOut',
    'DISPID_SGRSTsCount', 'DISPID_SRCEAudioLevel', 'DISPID_SPCLangId',
    'SPEI_SR_PRIVATE', 'DISPID_SFSOpen', 'SVP_14',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPIDSPTSI_ActiveLength',
    'SPPHRASERULE', 'SBONone', 'SpObjectTokenCategory',
    'SpeechStreamSeekPositionType', 'DISPID_SPPsItem',
    'DISPID_SBSRead', 'SpeechRecoContextState',
    'DISPID_SRSetPropertyString', 'DISPID_SpeechXMLRecoResult',
    'SVSFNLPSpeakPunc', 'SASClosed', 'eLEXTYPE_APP', 'SDTAll',
    'eLEXTYPE_PRIVATE4', 'ISpPhoneticAlphabetSelection',
    'SpWaveFormatEx', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SpeechVisemeType',
    'ISpeechAudioStatus', 'DISPID_SRRRecoContext',
    'ISpeechPhraseInfo', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRCEPropertyNumberChange', 'SVPNormal', 'STSF_AppData',
    'SVP_21', 'SREPropertyStringChange',
    'SWPUnknownWordUnpronounceable', 'DISPID_SRCRecognizer',
    'SSFMCreateForWrite', 'DISPID_SpeechAudioBufferInfo',
    'SPPS_Modifier', 'SVP_0', 'SPEI_ADAPTATION',
    'SVSFPurgeBeforeSpeak', 'SPFM_OPEN_READWRITE',
    'Speech_StreamPos_Asap', 'SPEI_TTS_AUDIO_LEVEL',
    'SPDKL_CurrentConfig', 'SPBO_NONE', 'DISPID_SPISaveToMemory',
    'SAFT44kHz16BitStereo', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_PRIVATE15', 'SRERecognition', 'SECNormalConfidence',
    'DISPID_SPIEnginePrivateData', 'DISPID_SVSpeak',
    'DISPID_SVSInputWordLength', 'DISPID_SVEWord', 'SRTEmulated',
    'SpeechAddRemoveWord', 'DISPID_SPEAudioTimeOffset', 'SGRSTTWord',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'DISPIDSPRG',
    'DISPID_SRRSpeakAudio', 'SGSEnabled', 'ISpeechDataKey',
    'SpeechGrammarState', 'SPEI_END_SR_STREAM',
    'SpeechPropertyResponseSpeed', 'ISpeechAudioFormat', 'SRSEDone',
    'DISPID_SRRTimes', 'SPPS_Function', 'DISPID_SRRTStreamTime',
    'SpeechRuleState', 'DISPID_SVGetAudioOutputs', 'SPRULESTATE',
    'DISPID_SRCESoundEnd', 'DISPID_SRIsShared',
    'ISpPhoneticAlphabetConverter', 'SBOPause', 'DISPID_SPIElements',
    'SpeechGrammarTagWildcard', 'SPGS_ENABLED', 'SPSInterjection',
    'ISpeechLexiconWord', 'SP_VISEME_19', 'SSTTTextBuffer',
    'DISPID_SLPsItem', 'DISPID_SAEventHandle',
    'DISPID_SpeechPhraseInfo', 'IInternetSecurityMgrSite',
    'SGLexical', 'SGSDisabled', 'WAVEFORMATEX',
    'DISPID_SVAudioOutputStream', 'SAFT24kHz16BitStereo',
    'SPTEXTSELECTIONINFO', 'DISPID_SDKDeleteValue',
    'DISPID_SVEViseme', 'SPRST_INACTIVE', 'SPVPRI_NORMAL',
    'DISPID_SBSSeek', 'SPSMF_UPS', 'SECLowConfidence',
    'SAFTADPCM_22kHzMono', 'SPEI_SOUND_START',
    'DISPID_SpeechLexiconProns', 'ISpeechResourceLoader',
    'DISPID_SRIsUISupported', 'DISPID_SVEPhoneme',
    'DISPID_SGRs_NewEnum', 'SPPS_RESERVED1', 'SRARoot',
    'SSSPTRelativeToEnd', 'SPRS_INACTIVE', 'SECFDefault',
    'DISPID_SRRTLength', 'DISPID_SPPs_NewEnum', 'SVEAudioLevel',
    'SpeechPropertyResourceUsage', 'DISPID_SOTs_NewEnum',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SVSkip', 'SLTApp',
    'DISPID_SVWaitUntilDone', 'DISPID_SPEAudioStreamOffset',
    'SPEI_RESERVED1', 'DISPID_SpeechVoiceEvent',
    'DISPID_SPIStartTime', 'DISPID_SPIReplacements',
    'ISpRecoContext2', 'DISPID_SLWsItem', 'SRTReSent',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SMSALineId',
    'SPINTERFERENCE_TOOQUIET', 'SPLO_STATIC',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SDKEnumValues',
    'SAFTNoAssignedFormat', 'DISPID_SGRSTPropertyId',
    'DISPID_SLWType', 'DISPID_SRRSaveToMemory',
    'DISPID_SVSRunningState', 'DISPID_SpeechPhraseRule',
    'DISPID_SRCBookmark', 'DISPID_SVPriority', 'SP_VISEME_15',
    'SpeechTokenContext', 'ISpeechVoice', 'ISpeechRecoResult2',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SPAPhraseInfo',
    'SPRST_ACTIVE_ALWAYS', 'ISpeechRecoResultDispatch',
    'SpPhoneConverter', 'DISPID_SRGReset', 'DISPID_SRCEPhraseStart',
    'SRAImport', 'DISPID_SpeechLexiconPronunciation',
    'SPPS_Interjection', 'SSFMCreate', 'SVSFParseMask',
    'SVEStartInputStream', 'SVSFIsNotXML', 'SPSVerb',
    'SpeechVoiceSpeakFlags', 'SAFT44kHz8BitStereo',
    'SpeechInterference', 'ISpeechPhraseElements',
    'SVSFParseAutodetect', 'SpeechVoiceCategoryTTSRate',
    'ISpeechObjectTokens', 'DISPID_SpeechAudioFormat',
    'ISpNotifySource', 'SDTAlternates', 'SWTDeleted',
    'SSSPTRelativeToCurrentPosition', 'SpAudioFormat',
    'SPXMLRESULTOPTIONS', 'DISPID_SMSGetData', 'SpSharedRecognizer',
    'SECFNoSpecialChars', 'ISpPhoneConverter', 'SAFT32kHz16BitMono',
    'SFTInput', 'eLEXTYPE_PRIVATE12', 'SPAR_Low',
    'DISPID_SDKEnumKeys', 'SPDKL_LocalMachine',
    'DISPID_SGRSAddWordTransition', 'SAFT11kHz8BitStereo',
    'DISPID_SpeechPhraseProperty', 'SAFT48kHz16BitMono',
    'SPWT_LEXICAL', 'DISPID_SPRuleFirstElement', 'DISPID_SDKOpenKey',
    'SpeechAudioFormatGUIDText', 'DISPID_SOTCDefault',
    'DISPID_SRRTTickCount', 'SREAllEvents', 'SPEI_MAX_SR',
    'DISPID_SVAudioOutput', 'SAFT22kHz8BitMono',
    'SAFTADPCM_8kHzStereo', 'SGLexicalNoSpecialChars',
    'SPEI_RESERVED5', 'DISPID_SRGDictationSetState', 'SASPause',
    'SAFT8kHz8BitMono', 'tagSTATSTG', 'SPLEXICONTYPE', 'SPAS_STOP',
    'DISPID_SAFSetWaveFormatEx', 'DISPID_SMSADeviceId',
    'SPGS_DISABLED', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SGRSTsItem', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SPRules_NewEnum', 'ISpNotifyTranslator',
    'SPEVENTSOURCEINFO', 'ISpPhrase', 'SPCT_DICTATION',
    'SPSEMANTICERRORINFO', 'SPEI_TTS_PRIVATE',
    'DISPID_SOTGetDescription', 'DISPID_SDKSetBinaryValue',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFT48kHz8BitMono',
    'SpeechSpecialTransitionType', 'SpCompressedLexicon',
    'SPBO_PAUSE', 'SAFT16kHz16BitStereo', 'SRERequestUI',
    'DISPID_SpeechCustomStream', 'SpeechCategoryAppLexicons',
    'DISPID_SWFESamplesPerSec', 'SPPHRASEREPLACEMENT',
    'DISPID_SpeechMemoryStream', 'SPSERIALIZEDRESULT',
    'SPFM_NUM_MODES', 'DISPID_SRGCmdLoadFromObject',
    'SAFT16kHz8BitMono', 'DISPID_SPAs_NewEnum', 'SPWORDPRONOUNCEABLE',
    'SpeechAudioFormatType', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SVResume', 'eLEXTYPE_PRIVATE2',
    'DISPID_SDKSetStringValue', 'DISPID_SPEs_NewEnum',
    'SPEI_HYPOTHESIS', 'SPPS_Verb', 'DISPID_SPRuleParent',
    'SpLexicon', 'DISPID_SRRAlternates', 'SRAExport',
    'SPEI_START_INPUT_STREAM', 'eLEXTYPE_LETTERTOSOUND',
    'SVESentenceBoundary', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SRGRules', 'DISPID_SVSLastBookmark',
    'SpeechCategoryPhoneConverters', 'SP_VISEME_10', 'SP_VISEME_12',
    'DISPID_SPERetainedSizeBytes', 'SRAInterpreter', 'SVSFVoiceMask',
    'SREStateChange', 'DISPID_SPRuleConfidence', 'SPRECOSTATE',
    'SPCT_SLEEP', 'ISpeechLexiconPronunciation', 'DISPID_SASState',
    'DISPID_SRAudioInputStream', 'SDKLCurrentUser',
    'DISPID_SWFEExtraData', 'SPSHT_OTHER', 'SP_VISEME_7', 'SVP_15',
    'DISPID_SRCResume', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SGRId', 'SPSHT_EMAIL',
    'SPVPRIORITY', 'DISPID_SWFEBlockAlign', 'ISpeechPhraseElement',
    'SPCONTEXTSTATE', 'DISPID_SRCEventInterests', 'DISPID_SOTRemove',
    'SpeechEngineConfidence', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SVSInputWordPosition', 'DISPID_SPIEngineId',
    'DISPID_SPRsCount', 'SWPUnknownWordPronounceable',
    'DISPID_SOTSetId', 'DISPID_SGRAttributes', 'SPPS_NotOverriden',
    'DISPID_SGRName', 'DISPID_SpeechGrammarRuleState',
    'SpeechDiscardType', 'tagSPPROPERTYINFO',
    'SPINTERFERENCE_TOOLOUD', 'IEnumString',
    'DISPID_SRGetPropertyString', 'DISPID_SVGetProfiles',
    'DISPID_SGRsCount', 'SINone', 'SVP_1', 'SpeechRecognizerState',
    'DISPID_SVSInputSentenceLength', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SLWLangId', 'SVF_None', 'eWORDTYPE_ADDED',
    'SpTextSelectionInformation', 'SPRECOCONTEXTSTATUS',
    'SVF_Emphasis', 'SpInprocRecognizer',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpNotifyTranslator', 'SPBOOKMARKOPTIONS', 'SAFTText',
    'SREBookmark', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SGRSTPropertyValue', 'eLEXTYPE_PRIVATE5',
    'DISPID_SLWs_NewEnum', 'DISPID_SABufferInfo',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SpeechGrammarRuleStateTransition', 'DISPID_SLPLangId',
    'SWTAdded', 'SAFT22kHz16BitMono', 'DISPID_SRGIsPronounceable',
    'SAFT16kHz16BitMono', 'DISPID_SpeechMMSysAudio',
    'DISPID_SpeechRecoContext', 'SPPS_LMA',
    'DISPIDSPTSI_ActiveOffset', 'SPSMF_SAPI_PROPERTIES',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SpeechCategoryAudioIn',
    'SAFTGSM610_44kHzMono', 'ISpRecognizer3', 'DISPID_SOTCGetDataKey',
    'DISPID_SPIProperties', 'DISPID_SPPChildren', 'SGPronounciation',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SREmulateRecognition',
    'DISPID_SGRSTPropertyName', 'DISPID_SRCCreateGrammar',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE3',
    'DISPID_SASNonBlockingIO', 'DISPID_SpeechObjectToken',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_3', 'SDA_One_Trailing_Space',
    'DISPID_SPIGetText', 'SVSFParseSsml', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SLGenerationId', 'SpObjectToken', 'SREAdaptation',
    'SPCT_COMMAND', 'DISPID_SPRText', 'DISPID_SVDisplayUI',
    'DISPID_SLPsCount', 'SPGS_EXCLUSIVE', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SOTsItem',
    'DISPID_SOTsCount', 'DISPID_SGRAddState', 'DISPID_SRCState',
    'ISpeechRecoContext', 'DISPID_SOTIsUISupported',
    'DISPID_SPRsItem', 'SpeechEmulationCompareFlags',
    'DISPID_SPAsCount', 'DISPID_SRCERequestUI',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpAudio', 'SPRULE',
    'DISPID_SVGetVoices', 'SPXRO_SML', 'SGRSTTRule', 'SREHypothesis'
]

_check_version('1.1.14', 1679120481.618658)
