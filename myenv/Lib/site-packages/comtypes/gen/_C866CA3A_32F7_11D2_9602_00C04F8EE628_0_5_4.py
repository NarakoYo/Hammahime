...
__all__ = [
    'SREAdaptation', 'SVP_1', 'SPEI_MAX_TTS',
    'SpTextSelectionInformation', 'SpPhoneConverter',
    'SAFTADPCM_11kHzStereo', 'eWORDTYPE_ADDED',
    'SAFTGSM610_11kHzMono', 'DISPID_SRRAudioFormat', 'SP_VISEME_8',
    'DISPID_SVWaitUntilDone', 'SPCATEGORYTYPE', 'ISpeechLexiconWord',
    'DISPID_SGRId', 'SGSEnabled', 'DISPID_SPIAudioSizeBytes',
    'SVSFNLPSpeakPunc', 'DISPID_SPEPronunciation',
    'SPFM_OPEN_READWRITE', 'DISPIDSPRG', 'SPBO_AHEAD',
    'SPXRO_Alternates_SML', 'SRSInactive', 'SVSFPersistXML',
    'SDTLexicalForm', 'SpeechGrammarState', 'eLEXTYPE_PRIVATE11',
    'SAFT48kHz16BitMono', 'SPEI_PHONEME', 'SpeechWordPronounceable',
    'DISPID_SRGCmdSetRuleState', 'ISpRecoGrammar2',
    'DISPID_SRRTStreamTime', 'SVEEndInputStream',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCERecognizerStateChange',
    'Speech_StreamPos_RealTime', 'ISpeechTextSelectionInformation',
    'SLODynamic', 'DISPID_SLWPronunciations', 'SGSExclusive',
    'SVEPhoneme', 'SVP_17', 'SVESentenceBoundary',
    'DISPID_SDKSetBinaryValue', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SVAudioOutputStream', 'DISPID_SPRuleConfidence',
    'DISPID_SLAddPronunciation', 'SpeechFormatType',
    'DISPID_SRCState', 'DISPID_SMSADeviceId', 'DISPID_SRIsShared',
    'SpeechCategoryAppLexicons', 'DISPID_SPRNumberOfElements',
    'DISPID_SPIGetDisplayAttributes', 'ISpeechPhraseRule',
    'SAFT44kHz16BitMono', 'SPPS_LMA', 'SPPS_Noncontent',
    'ISpeechMMSysAudio', 'SVSFParseSapi', 'DISPID_SOTCSetId',
    'SpeechEmulationCompareFlags', 'DISPID_SVIsUISupported',
    'SSTTTextBuffer', 'SPAS_RUN', 'SPDATAKEYLOCATION',
    'eLEXTYPE_PRIVATE18', 'DISPID_SpeechAudioBufferInfo',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SOTSetId',
    'DISPID_SVSpeakStream', 'ISpObjectTokenCategory',
    'ISpeechPhraseProperty', 'SGDSInactive', 'SPCS_ENABLED',
    'SPEI_PHRASE_START', 'DISPID_SPEAudioTimeOffset',
    'SpeechTokenContext', 'SVSFParseSsml', 'SPPS_NotOverriden',
    'SPAUDIOSTATE', 'SpeechGrammarTagUnlimitedDictation',
    'DISPID_SVSpeakCompleteEvent', 'SpInprocRecognizer',
    'ISpShortcut', 'SAFT8kHz8BitMono', 'DISPID_SpeechGrammarRule',
    'DISPID_SRCEPropertyStringChange', 'SPINTERFERENCE_TOOQUIET',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechPhraseInfo',
    'SPSERIALIZEDPHRASE', 'DISPID_SpeechLexiconProns', 'SPVPRI_OVER',
    'eLEXTYPE_PRIVATE16', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SpeechFileStream', 'ISpeechObjectTokenCategory',
    'ISpRecoContext', 'SPGRAMMARSTATE', 'DISPID_SAVolume',
    'DISPID_SpeechPhraseRule', 'SPPS_RESERVED4', 'SVSFIsFilename',
    'DISPID_SLPsCount', 'SPRULE', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SRCERecognition',
    'DISPID_SGRsDynamic', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGetPropertyNumber',
    'SPEI_RESERVED1', 'DISPID_SLWs_NewEnum', 'SPEI_UNDEFINED',
    'SpeechPropertyResponseSpeed', 'SREStreamEnd', 'SSTTWildcard',
    'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCCmdMaxAlternates', 'SPRST_ACTIVE_ALWAYS',
    'SREBookmark', 'SPGS_EXCLUSIVE', 'DISPID_SpeechMMSysAudio',
    'DISPID_SWFEBitsPerSample', 'ISpeechFileStream', 'SRTSMLTimeout',
    'DISPID_SRGDictationSetState', 'SECFDefault',
    'SPEI_START_SR_STREAM', 'DISPID_SRGSetTextSelection',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPVOICESTATUS',
    'SPINTERFERENCE', 'SPWORDPRONOUNCEABLE',
    'ISpPhoneticAlphabetConverter', 'SPFILEMODE',
    'SpSharedRecognizer', 'SPPS_Modifier', 'DISPID_SPIReplacements',
    'DISPID_SVPriority', 'DISPID_SPRuleId', 'DISPID_SOTCategory',
    'DISPID_SpeechAudioStatus', 'SpMMAudioOut', 'DISPID_SPPsItem',
    'SPEI_ADAPTATION', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPAsItem', 'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SVEWord', 'DISPID_SGRSTNextState', 'SDTAlternates',
    'ISpeechPhraseRules', 'SAFTADPCM_8kHzMono', 'SECFNoSpecialChars',
    'ISpeechBaseStream', 'SPSHORTCUTPAIR', 'SPWORDPRONUNCIATION',
    'SGSDisabled', 'DISPIDSPTSI_ActiveLength', 'eLEXTYPE_PRIVATE4',
    'SAFTDefault', 'DISPID_SWFEExtraData', 'DISPID_SADefaultFormat',
    'SVSFPurgeBeforeSpeak', 'DISPID_SpeechAudio',
    'DISPID_SpeechLexiconPronunciation', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCPause', 'SP_VISEME_0', 'SSTTDictation',
    'eLEXTYPE_RESERVED4', 'SGRSTTRule', 'DISPID_SPIEngineId',
    'DISPID_SVSVisemeId', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechLexicon', 'SpeechAudioFormatGUIDWave',
    'SRCS_Disabled', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechPhraseElements', 'SAFT16kHz16BitMono', 'SPSFunction',
    'SP_VISEME_20', 'DISPID_SGRsAdd', 'DISPID_SASState',
    'SPDKL_LocalMachine', 'SAFT16kHz16BitStereo',
    'DISPID_SRRTTickCount', 'SAFT12kHz8BitStereo',
    'SpeechCategoryAudioOut', 'SRSActive', 'ISpSerializeState',
    'SPEI_INTERFERENCE', 'SpeechCategoryVoices',
    'DISPID_SPARecoResult', 'SPXMLRESULTOPTIONS',
    'SpeechDataKeyLocation', 'SPPHRASERULE', 'SDTAudio',
    'DISPID_SVSLastBookmark', 'ISpeechGrammarRule',
    'DISPID_SPEActualConfidence', 'SpeechDiscardType',
    'ISpeechGrammarRuleState', 'SASStop', 'SPEI_MIN_SR',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SCSBaseStream',
    ...
    'DISPID_SOTCId', 'SRTStandard', 'SREPrivate', 'DISPID_SPAsCount',
    'DISPID_SRCEEndStream', 'SVP_14', 'SVEAudioLevel',
    'SVSFVoiceMask', 'ISpeechPhraseReplacements', 'SpStream',
    'SpeechPropertyAdaptationOn', 'SAFTGSM610_8kHzMono',
    'DISPID_SVSPhonemeId', 'ISpeechObjectTokens',
    'SpeechGrammarTagWildcard', 'SPBINARYGRAMMAR',
    'tagSPTEXTSELECTIONINFO', 'SPRECOGNIZERSTATUS',
    'SPINTERFERENCE_NOSIGNAL', 'SP_VISEME_9',
    'SAFTCCITT_ALaw_11kHzStereo', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SGRClear', 'DISPID_SPPName', 'ISpeechAudioFormat',
    'SpeechTokenKeyFiles', 'SP_VISEME_18', 'SVP_8', 'STCAll',
    'ISpeechRecognizer', 'SpeechLexiconType', 'SAFT22kHz8BitStereo',
    'SVEPrivate', 'SpeechVisemeType', '_SPAUDIOSTATE', 'eLEXTYPE_APP',
    'DISPID_SRCERequestUI', 'DISPID_SRCSetAdaptationData',
    'DISPID_SMSALineId', 'DISPID_SOTIsUISupported', 'tagSTATSTG',
    'SVEStartInputStream', 'DISPID_SRCCreateGrammar',
    'DISPID_SOTDisplayUI', 'DISPID_SPEs_NewEnum', 'SAFT11kHz8BitMono',
    'ISequentialStream', 'DISPID_SRRGetXMLErrorInfo', 'SpAudioFormat',
    'SAFTText', 'DISPID_SGRAddResource', 'DISPID_SOTCGetDataKey',
    'SpMMAudioIn', 'eLEXTYPE_PRIVATE15', 'SPSMF_SRGS_SAPIPROPERTIES',
    'ISpeechRecoResultDispatch', 'SpUnCompressedLexicon',
    'SPSHT_Unknown', 'DISPID_SVGetAudioInputs', 'DISPID_SMSGetData',
    'SDA_One_Trailing_Space', 'DISPID_SVGetProfiles',
    'DISPID_SpeechAudioFormat', 'SGRSTTWildcard',
    'DISPID_SVEVoiceChange', 'DISPIDSPTSI_SelectionOffset',
    'SPSHORTCUTPAIRLIST', 'SPLEXICONTYPE',
    'DISPID_SpeechWaveFormatEx', 'DISPID_SAFSetWaveFormatEx',
    'SDKLCurrentConfig', 'SpeechAddRemoveWord', 'SpSharedRecoContext',
    'DISPID_SAFGuid', 'STCRemoteServer', 'DISPID_SVRate',
    'SDA_Consume_Leading_Spaces', 'SPDKL_CurrentUser',
    'SPPS_RESERVED3', 'SPPS_Function',
    'DISPID_SpeechGrammarRuleStateTransition', 'ISpRecoResult',
    'SVSFNLPMask', 'DISPID_SBSSeek', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SGRsItem',
    'ISpeechRecognizerStatus', 'DISPID_SGRsCount', 'ISpDataKey',
    'SWTDeleted', 'DISPID_SpeechPhoneConverter', 'SRESoundEnd',
    'SPPHRASE', 'SPCONTEXTSTATE', 'SPCT_SUB_COMMAND',
    'SpeechAudioVolume', 'SPADAPTATIONRELEVANCE',
    'SpeechRecognitionType', 'ISpeechObjectToken', 'SECFIgnoreCase',
    'SPWAVEFORMATTYPE', 'SAFT44kHz16BitStereo', 'SPFM_NUM_MODES',
    'DISPID_SRCAudioInInterferenceStatus', 'SPSHT_EMAIL', 'SPWORD',
    'SASClosed', 'ISpeechGrammarRuleStateTransition',
    'Speech_Max_Pron_Length', 'ISpPhoneConverter',
    'SAFTADPCM_44kHzMono', 'SpeechRunState', 'DISPID_SVAlertBoundary',
    'SRCS_Enabled', 'SAFTADPCM_22kHzStereo', 'SPPS_RESERVED2',
    'DISPID_SPIElements', 'SECFIgnoreKanaType',
    'DISPID_SPIProperties', 'SPSTREAMFORMATTYPE',
    'SpeechCategoryRecognizers', 'DISPID_SPAs_NewEnum',
    'ISpPhoneticAlphabetSelection', 'ISpLexicon', 'SRAExport',
    'SRAImport', 'SPWT_DISPLAY', 'DISPID_SRGRules', 'SRARoot',
    'SpeechGrammarTagDictation', 'Speech_Default_Weight',
    'DISPID_SPPParent', 'SGDSActiveWithAutoPause',
    'SAFT32kHz16BitStereo', 'SAFTCCITT_uLaw_44kHzStereo', 'ISpVoice',
    'DISPID_SGRSTRule', 'DISPID_SGRSTPropertyValue',
    'SAFT44kHz8BitStereo', 'DISPID_SREmulateRecognition',
    'DISPID_SpeechGrammarRules', 'DISPID_SpeechPhraseProperty',
    'SpeechVisemeFeature', 'ISpRecoGrammar', 'SPEI_RESERVED6',
    'DISPID_SRCEAdaptation', 'DISPID_SGRName', 'SAFT16kHz8BitMono',
    'DISPID_SGRsCommit', 'SGDisplay', 'DISPID_SpeechPhraseRules',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRRTOffsetFromStart',
    'SPRST_INACTIVE_WITH_PURGE', 'SPPHRASEPROPERTY', 'SITooFast',
    'DISPID_SGRSTransitions', 'SPAO_NONE', 'DISPID_SBSFormat',
    'SpeechRecoProfileProperties', 'SPRULESTATE',
    'DISPID_SOTCEnumerateTokens', 'SRSInactiveWithPurge',
    'SpeechPropertyResourceUsage', 'DISPID_SRRTimes',
    'DISPID_SVSInputWordLength', 'DISPID_SRRTLength',
    'DISPID_SRSetPropertyNumber', 'SPDKL_DefaultLocation',
    'DISPID_SWFEChannels', 'DISPID_SGRSAddWordTransition',
    'DISPID_SPRFirstElement', 'DISPID_SLPPhoneIds',
    'SpNotifyTranslator', 'DISPID_SGRsFindRule', 'SPEI_SR_PRIVATE',
    ...
    'SpeechRegistryUserRoot', 'UINT_PTR', 'SAFTExtendedAudioFormat',
    'SVP_4', 'SRTEmulated', 'eLEXTYPE_PRIVATE10', 'SPEI_VOICE_CHANGE',
    'DISPID_SRCBookmark', 'SECNormalConfidence', 'SVP_15',
    'DISPID_SpeechObjectTokens', 'SAFT16kHz8BitStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SITooLoud',
    'SP_VISEME_11', 'DISPID_SOTDataKey', 'SPBO_PAUSE',
    'SpMMAudioEnum', 'DISPID_SGRSTsCount', 'SpeechRuleAttributes',
    'DISPID_SPEEngineConfidence', 'SP_VISEME_6',
    'SpInProcRecoContext', '__MIDL_IWinTypes_0009', 'SVP_21',
    'DISPID_SRSetPropertyString', 'SPEI_RECOGNITION',
    'DISPID_SOTGetDescription', 'SECFEmulateResult',
    'SAFT24kHz8BitMono', 'SPAS_STOP', 'DISPID_SLPSymbolic',
    'SREStreamStart', 'ISpeechPhraseAlternates', 'DISPID_SLPsItem',
    'DISPID_SPRText', 'SPSHORTCUTTYPE', 'DISPID_SPRuleChildren',
    'SPVPRI_NORMAL', 'SRTExtendableParse',
    'SpeechSpecialTransitionType', 'SAFT48kHz8BitMono',
    'eLEXTYPE_MORPHOLOGY', 'SpVoice', 'DISPID_SpeechVoice', 'SVP_0',
    'ISpPhrase', 'SRSEDone', 'eLEXTYPE_PRIVATE20', 'DISPID_SRProfile',
    'SASPause', 'SPPROPERTYINFO', 'SP_VISEME_2',
    'DISPID_SpeechPhraseReplacements', 'SPAS_PAUSE',
    'DISPID_SRCESoundEnd', 'DISPID_SVEBookmark', 'DISPID_SPRsCount',
    'DISPID_SPEDisplayAttributes', 'SpObjectTokenCategory',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPRsItem', 'SpCustomStream',
    'eWORDTYPE_DELETED', 'SPINTERFERENCE_TOOLOUD', 'SSFMCreate',
    'SPLOADOPTIONS', 'DISPID_SGRSTPropertyId',
    'DISPID_SOTCreateInstance', 'SPWT_LEXICAL',
    'DISPID_SOTMatchesAttributes', 'SpeechCategoryRecoProfiles',
    'DISPID_SRSCurrentStreamPosition', 'SDTAll',
    'DISPID_SPCPhoneToId', 'DISPID_SMSAMMHandle',
    'SpeechTokenShellFolder', 'SRERecoOtherContext',
    'SPGRAMMARWORDTYPE', 'DISPID_SPRules_NewEnum',
    'DISPID_SLGetPronunciations', 'SPCT_SUB_DICTATION',
    'SpeechAllElements', 'DISPID_SpeechPhraseAlternates',
    'ISpXMLRecoResult', 'eLEXTYPE_PRIVATE13', 'STCInprocServer',
    'SPLO_STATIC', 'DISPID_SRCEStartStream', 'SDA_No_Trailing_Space',
    'DISPID_SpeechCustomStream', 'SDTRule',
    'DISPID_SRCEPropertyNumberChange', 'SVP_16',
    'SpeechVoicePriority', 'DISPID_SGRSTWeight',
    '_ISpeechRecoContextEvents', 'SPWT_PRONUNCIATION',
    'DISPID_SRRSaveToMemory', 'DISPID_SRRAudio', 'SSSPTRelativeToEnd',
    'DISPID_SLGetWords', 'SPFM_CREATE', 'DISPID_SpeechPhraseElement',
    'SPAR_Medium', 'DISPID_SASNonBlockingIO', 'SPEI_HYPOTHESIS',
    'DISPID_SRCEBookmark', 'ISpeechPhraseInfoBuilder',
    'ISpeechAudioBufferInfo', 'SPSERIALIZEDRESULT',
    'DISPID_SRCEInterference', 'ISpeechRecoContext',
    'DISPID_SDKEnumKeys', 'SAFTGSM610_44kHzMono', 'SP_VISEME_14',
    'DISPID_SDKGetlongValue', 'ISpeechRecoResult2',
    'SAFT12kHz16BitMono', 'SpeechTokenValueCLSID', 'SVEViseme',
    'DISPID_SAEventHandle', 'SVP_19', 'DISPID_SDKGetBinaryValue',
    'SPEI_SOUND_START', 'ISpeechAudioStatus',
    'DISPID_SRGCmdLoadFromObject', 'DISPID_SPAStartElementInResult',
    'SAFT22kHz16BitMono', 'DISPID_SDKDeleteKey', 'SPWORDLIST',
    'SRERecognition', 'SPRST_NUM_STATES', 'SSSPTRelativeToStart',
    'DISPID_SLPType', 'ISpeechPhraseProperties',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPEAudioSizeTime',
    'SpeechPropertyComplexResponseSpeed', 'tagSPPROPERTYINFO',
    'SPEI_REQUEST_UI', 'SDKLCurrentUser', 'SPEI_MAX_SR',
    'DISPID_SLGetGenerationChange', 'SREStateChange', 'SPEVENT',
    'DISPID_SVSLastStreamNumberQueued', 'SPEI_RESERVED2',
    'DISPID_SRCEFalseRecognition', 'ISpProperties',
    'DISPID_SVAudioOutput', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SLWLangId', 'SDKLDefaultLocation', 'DISPID_SPPChildren',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPBOOKMARKOPTIONS',
    'DISPID_SOTGetAttribute', 'SpeechVoiceEvents',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpNotifySource',
    'SP_VISEME_12', 'DISPID_SVPause', 'SPAR_Unknown', 'SPPS_Noun',
    'SECHighConfidence', 'DISPID_SPERequiredConfidence',
    'SpeechAudioFormatGUIDText', 'DISPID_SVEEnginePrivate',
    'DISPID_SRCEAudioLevel', 'SPFM_CREATE_ALWAYS',
    'ISpeechPhraseInfo', 'DISPID_SDKCreateKey',
    'DISPID_SWFEAvgBytesPerSec', 'ISpStreamFormatConverter',
    'DISPID_SRIsUISupported', 'SAFT22kHz8BitMono',
    'DISPID_SLPs_NewEnum', 'SINoSignal', 'DISPID_SPEsItem',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechPhraseProperties',
    'SpeechDisplayAttributes', 'DISPID_SPPValue',
    'DISPID_SPPEngineConfidence', 'DISPID_SVSInputSentenceLength',
    'SAFT11kHz8BitStereo', 'SP_VISEME_13', 'DISPID_SRGCommit',
    'ISpeechPhoneConverter', 'eLEXTYPE_USER',
    'DISPID_SVSLastBookmarkId', 'DISPID_SLGenerationId',
    'DISPID_SVSRunningState', 'SVP_10', 'SPPS_Verb',
    'SRADefaultToActive', 'SPEI_WORD_BOUNDARY', 'SPEVENTENUM',
    'SSFMOpenForRead', 'SWPUnknownWordPronounceable',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SRState',
    'DISPID_SLWsItem', 'SGPronounciation', 'IEnumString',
    'DISPID_SBSWrite', 'ISpRecoCategory', 'SPBO_TIME_UNITS',
    'DISPID_SPEDisplayText', 'DISPID_SRRRecoContext',
    '_ISpeechVoiceEvents', 'DISPID_SPPId', 'DISPID_SPILanguageId',
    'STSF_LocalAppData', 'ISpeechRecoResultTimes',
    'DISPID_SRGetPropertyString', 'ISpeechPhraseElement',
    'DISPID_SPELexicalForm', 'DISPID_SPERetainedStreamOffset',
    'DISPID_SRRPhraseInfo', 'DISPID_SABufferNotifySize',
    'DISPID_SLPPartOfSpeech', 'ISpeechRecoGrammar', 'DISPID_SVVolume',
    'SVEBookmark', 'DISPID_SPCLangId', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRGId', 'DISPID_SVEventInterests',
    'Speech_Max_Word_Length', 'SBONone', 'SPPS_SuppressWord',
    'DISPID_SGRAddState', 'SREFalseRecognition',
    'DISPID_SPPNumberOfElements', 'SP_VISEME_19', 'SPAUDIOSTATUS',
    'SpeechRuleState', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SWFESamplesPerSec', 'SVP_11', 'ISpeechAudio',
    'SAFTCCITT_ALaw_8kHzMono', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechPhraseAlternate', 'SPCT_SLEEP',
    'SWPKnownWordPronounceable', 'SVP_18', 'ISpeechDataKey',
    'SpeechAudioFormatType', 'DISPID_SRGCmdLoadFromResource',
    'SPEI_SOUND_END', 'SpeechTokenKeyUI', 'ISpObjectWithToken',
    'SPDKL_CurrentConfig', 'DISPID_SRSCurrentStreamNumber', 'SVP_20',
    'SPEI_START_INPUT_STREAM', 'IStream', 'ISpNotifyTranslator',
    'DISPID_SpeechRecoResult', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SRCEPhraseStart', 'SpeechRecoContextState',
    'SAFT24kHz16BitStereo', 'DISPID_SGRSRule', 'SpWaveFormatEx',
    'SpNullPhoneConverter', 'SPAUDIOOPTIONS', 'SPEVENTSOURCEINFO',
    'ISpeechVoiceStatus', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SPIGetText', 'SPPS_Interjection', 'DISPID_SPRulesCount',
    'SpShortcut', 'SAFTCCITT_uLaw_11kHzStereo', 'SPBO_NONE',
    'SPEI_TTS_PRIVATE', 'DISPID_SPIAudioStreamPosition',
    'DISPID_SRCCreateResultFromMemory', 'SGDSActiveUserDelimited',
    'DISPID_SPRulesItem', 'SPSEMANTICFORMAT', 'ISpeechResourceLoader',
    'SPEI_RECO_STATE_CHANGE', 'SpeechEngineProperties',
    'DISPID_SPRuleName', 'ISpEventSink', 'eLEXTYPE_PRIVATE5',
    'SPEI_TTS_BOOKMARK', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SpeechLexiconWord',
    'DISPID_SVGetVoices', 'SAFTCCITT_uLaw_11kHzMono', 'ISpeechVoice',
    'SPAUDIOBUFFERINFO', 'DISPID_SRCRecognizer',
    'DISPID_SGRAttributes', 'ISpAudio',
    'DISPID_SRSNumberOfActiveRules', 'ISpEventSource',
    'DISPID_SpeechVoiceStatus', 'DISPID_SLWType',
    'DISPID_SRSClsidEngine', 'SVF_Emphasis', 'SPVPRI_ALERT',
    'SpeechStreamFileMode', 'DISPIDSPTSI_SelectionLength', 'SWTAdded',
    'DISPID_SPPConfidence', 'DISPID_SMSSetData',
    'ISpeechLexiconPronunciations', 'SPSVerb', 'SRATopLevel',
    'ISpNotifySink', 'SGLexical', 'SDTPronunciation',
    'DISPID_SPAPhraseInfo', 'DISPID_SLAddPronunciationByPhoneIds',
    'DISPID_SRCEventInterests', 'eLEXTYPE_RESERVED10',
    'SRAORetainAudio', 'SPRECOCONTEXTSTATUS',
    'DISPID_SVGetAudioOutputs', 'SAFTCCITT_ALaw_22kHzStereo',
    'ISpeechGrammarRuleStateTransitions', 'SpPhraseInfoBuilder',
    'SAFT32kHz16BitMono', 'SpObjectToken', 'SREInterference',
    'DISPID_SpeechLexiconWords', 'SPEI_VISEME',
    'DISPID_SABIMinNotification', 'eLEXTYPE_RESERVED8',
    'eLEXTYPE_PRIVATE2', 'DISPIDSPTSI', 'DISPID_SRAudioInput',
    'SPRECORESULTTIMES', 'SP_VISEME_4',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SpeechObjectToken',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPCT_COMMAND',
    'SpeechCategoryPhoneConverters', 'SREPropertyNumChange',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SDKSetLongValue',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_RESERVED3',
    'STSF_CommonAppData', 'SPGS_ENABLED', 'SVSFParseMask',
    'STSF_AppData', 'SVP_2', 'SPAS_CLOSED',
    'DISPID_SPERetainedSizeBytes', 'SPWORDTYPE', '_RemotableHandle',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SVSInputWordPosition',
    'DISPID_SVEViseme', 'DISPID_SpeechRecoResultTimes',
    ...
    'DISPID_SPRDisplayAttributes', 'WAVEFORMATEX', 'SRTAutopause',
    'ISpStream', 'SPWORDPRONUNCIATIONLIST', 'DISPID_SFSClose',
    'DISPID_SBSRead', 'SP_VISEME_17', 'SDTProperty',
    'DISPID_SAStatus', 'SpeechAudioProperties',
    'DISPID_SpeechDataKey', 'ISpPhraseAlt',
    'DISPID_SRGIsPronounceable', 'SPSNoun', 'DISPID_SPACommit',
    'DISPID_SPPs_NewEnum', 'DISPID_SPRuleNumberOfElements',
    'DISPID_SRCEHypothesis', 'SAFTNonStandardFormat',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT11kHz16BitStereo', 'SVP_3', 'DISPID_SOTId', 'SVPNormal',
    'DISPID_SOTRemoveStorageFileName', 'SP_VISEME_7',
    'DISPID_SPPFirstElement', 'DISPID_SVSpeak', 'SAFT24kHz8BitStereo',
    'SPPHRASEELEMENT', 'SP_VISEME_21', 'SPSUnknown', 'SRERequestUI',
    'DISPID_SPIStartTime', 'SVEVoiceChange', 'DISPID_SVEPhoneme',
    'SPWF_INPUT', 'eLEXTYPE_PRIVATE1', 'DISPID_SRGetRecognizers',
    'SDKLLocalMachine', 'SPVISEMES', 'SVPAlert',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'Speech_StreamPos_Asap', 'SGDSActive', 'SAFT12kHz16BitStereo',
    'eLEXTYPE_PRIVATE9', 'SpStreamFormatConverter', 'SPRST_INACTIVE',
    'SAFT11kHz16BitMono', 'SECLowConfidence', 'SPSHT_OTHER',
    'DISPID_SWFEBlockAlign', 'DISPID_SGRs_NewEnum',
    'SpeechRetainedAudioOptions', 'SRSEIsSpeaking', 'SGRSTTWord',
    'SVSFIsXML', 'SREPropertyStringChange', 'DISPID_SPEsCount',
    'SpMemoryStream', 'SECFIgnoreWidth', 'ISpeechPhraseAlternate',
    'SPEI_TTS_AUDIO_LEVEL', 'ISpeechMemoryStream',
    'SpeechEngineConfidence', 'eLEXTYPE_LETTERTOSOUND',
    'ISpResourceManager', 'DISPID_SVVoice', 'SFTSREngine',
    'DISPID_SDKGetStringValue', 'SpPhoneticAlphabetConverter',
    'SITooSlow', 'DISPID_SLWWord', 'ISpGrammarBuilder',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechLoadOption',
    'DISPID_SASetState', 'DISPID_SGRSTs_NewEnum', 'SPAR_High',
    'DISPID_SRCRetainedAudio', 'SAFT8kHz8BitStereo',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SLWsCount',
    'ISpMMSysAudio', 'SpeechVoiceCategoryTTSRate', 'DISPID_SGRSTText',
    'DISPID_SRCEEnginePrivate', 'SAFT48kHz16BitStereo',
    'SP_VISEME_15', 'SPLO_DYNAMIC', 'SGRSTTTextBuffer',
    'SAFTTrueSpeech_8kHz1BitMono', 'eLEXTYPE_PRIVATE8',
    'SPSNotOverriden', 'SVP_13', 'ISpRecognizer3',
    'DISPID_SPPBRestorePhraseFromMemory', 'SRTReSent',
    'DISPID_SGRInitialState', 'SpeechPartOfSpeech',
    'eLEXTYPE_PRIVATE7', 'SAFT24kHz16BitMono', 'ISpStreamFormat',
    'SAFT44kHz8BitMono', 'DISPID_SPISaveToMemory', 'SLTApp',
    'SDA_Two_Trailing_Spaces', 'SPEI_SR_RETAINEDAUDIO',
    'SDTReplacement', 'eLEXTYPE_PRIVATE3', 'SGLexicalNoSpecialChars',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_16', 'SVEWordBoundary',
    'SVEAllEvents', 'DISPID_SpeechRecognizerStatus',
    'SpeechDictationTopicSpelling', 'DISPID_SVSLastResult',
    'SVSFIsNotXML', 'DISPID_SRGDictationLoad', 'SSFMCreateForWrite',
    'DISPID_SRGReset', 'ISpeechLexicon', 'SPWF_SRENGINE',
    'SpeechCategoryAudioIn', 'SPSEMANTICERRORINFO',
    'SAFT8kHz16BitMono', 'ISpeechRecoResult', 'SBOPause',
    'SpeechWordType', 'DISPID_SABIBufferSize', 'SpeechAudioState',
    'DISPID_SRRGetXMLResult', 'DISPID_SRSAudioStatus',
    'SPEI_END_SR_STREAM', 'SLOStatic', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_SR_AUDIO_LEVEL', 'DISPID_SPIRule', 'SGRSTTEpsilon',
    'SpeechTokenKeyAttributes', 'DISPID_SpeechPhraseElements',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SREPhraseStart',
    'SASRun', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SRDisplayUI', 'SVF_None', 'SREAllEvents', 'SPVPRIORITY',
    'DISPID_SVEStreamEnd', 'DISPID_SPIGrammarId', 'DISPID_SFSOpen',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPSModifier',
    'SPRS_INACTIVE', 'DISPID_SRCVoice', 'SPINTERFERENCE_NONE',
    'SPRST_ACTIVE', 'DISPID_SRRecognizer', 'SVP_5', 'DISPID_SOTsItem',
    'SPRECOSTATE', 'SpeechUserTraining', 'ISpRecognizer2',
    'DISPID_SpeechVoiceEvent', 'SPEI_MIN_TTS', 'eLEXTYPE_PRIVATE12',
    'ISpObjectToken', 'DISPIDSPTSI_ActiveOffset', 'ISpRecoContext2',
    'DISPID_SVEStreamStart', 'SP_VISEME_10',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'eLEXTYPE_PRIVATE6',
    'SPSMF_UPS', 'SPAO_RETAIN_AUDIO', 'SpeechMicTraining',
    'SAFTCCITT_uLaw_22kHzMono', 'SREHypothesis', 'SLTUser',
    'SAFTADPCM_11kHzMono', 'IEnumSpObjectTokens',
    'SpeechStreamSeekPositionType', 'SVP_7',
    'DISPID_SpeechRecoResult2', 'SpeechInterference',
    'SAFT22kHz16BitStereo', 'DISPID_SABufferInfo',
    'SAFTCCITT_uLaw_22kHzStereo', 'SVSFParseAutodetect',
    'SVF_Stressed', 'DISPID_SPRuleFirstElement',
    'DISPID_SRCESoundStart', 'DISPID_SRStatus', 'DISPID_SVDisplayUI',
    'DISPID_SRCRequestedUIType',
    'SpeechPropertyHighConfidenceThreshold', 'SAFTADPCM_44kHzStereo',
    'SpResourceManager', 'SPPHRASEREPLACEMENT',
    'DISPID_SDKSetStringValue', 'DISPID_SVResume', 'SpFileStream',
    'eLEXTYPE_RESERVED6', 'DISPID_SOTGetStorageFileName',
    'SpeechRecognizerState', 'SPAR_Low', 'DISPID_SOTRemove',
    'DISPID_SOTCDefault', 'DISPID_SDKOpenKey', 'SPPS_RESERVED1',
    'SpeechVoiceSpeakFlags', 'SpLexicon', 'SAFTGSM610_22kHzMono',
    'eLEXTYPE_USER_SHORTCUT', 'SVP_9', 'DISPID_SRRAlternates',
    'SpeechGrammarWordType', 'SDTDisplayText', 'DISPID_SVSkip',
    'SVSFlagsAsync', 'SPPARTOFSPEECH',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SRCResume',
    'DISPID_SOTs_NewEnum', 'DISPID_SDKDeleteValue', 'SVP_12',
    'SREAudioLevel', 'SAFTCCITT_uLaw_8kHzMono',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SAFT32kHz8BitStereo',
    'DISPID_SWFEFormatTag', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SRADynamic', 'SGRSTTDictation',
    'DISPID_SVSInputSentencePosition', 'SP_VISEME_1',
    'DISPID_SPRuleParent', 'SRAONone', 'DISPID_SPRs_NewEnum',
    ...
    'SpeechPropertyNormalConfidenceThreshold', 'SVSFDefault',
    'LONG_PTR', 'DISPID_SGRsCommitAndSave', 'SPTEXTSELECTIONINFO',
    'SVPOver', 'SFTInput', 'SAFTADPCM_22kHzMono',
    'DISPID_SABIEventBias', 'eLEXTYPE_PRIVATE14',
    'SAFT8kHz16BitStereo', 'DISPID_SAFType', 'SVP_6', 'SPSLMA',
    'DISPID_SPIAudioSizeTime', 'DISPID_SGRSTType', 'SPXRO_SML',
    'SPEI_RESERVED5', 'SSFMOpenReadWrite',
    'ISpeechLexiconPronunciation', 'SPCS_DISABLED',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPCT_DICTATION',
    'SINone', 'SPSInterjection', 'SITooQuiet', 'DISPID_SOTsCount',
    'SPEI_SR_BOOKMARK', 'IInternetSecurityMgrSite',
    'SPEI_FALSE_RECOGNITION', 'SAFT12kHz8BitMono',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SRGRecoContext',
    'eLEXTYPE_PRIVATE19', 'DISPID_SRSSupportedLanguages',
    'DISPID_SpeechMemoryStream', 'SPEI_PROPERTY_NUM_CHANGE',
    'SAFTNoAssignedFormat', 'DISPID_SPANumberOfElementsInResult',
    'STCLocalServer', 'STSF_FlagCreate',
    'DISPID_SVSyncronousSpeakTimeout', 'SP_VISEME_3',
    'DISPID_SpeechPhraseReplacement', 'ISpeechGrammarRules',
    'DISPID_SLRemovePronunciation', 'SPRS_ACTIVE',
    'DISPID_SpeechRecoContextEvents', 'SAFT32kHz8BitMono',
    'ISpeechPhraseReplacement', 'DISPID_SPCIdToPhone',
    'SpCompressedLexicon', 'SpeechRecoEvents',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SVEAudioLevel',
    'SPINTERFERENCE_NOISE', 'SINoise', 'SRAInterpreter',
    'DISPID_SpeechBaseStream', 'SP_VISEME_5', 'SpeechBookmarkOptions',
    'SAFT48kHz8BitStereo', 'STCInprocHandler',
    'IInternetSecurityManager', 'SRSActiveAlways',
    'DISPID_SRGDictationUnload', 'DISPID_SRCreateRecoContext',
    'SPFM_OPEN_READONLY', 'SRESoundStart',
    'DISPID_SRGCmdSetRuleIdState', 'SPSHT_NotOverriden',
    'DISPID_SGRSTsItem', 'DISPID_SRRSpeakAudio', 'DISPID_SRGState',
    'SPGS_DISABLED', 'SWPUnknownWordUnpronounceable',
    'DISPID_SGRSTPropertyName', 'DISPID_SRRSetTextFeedback',
    'SVSFUnusedFlags', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SLPLangId'
]
