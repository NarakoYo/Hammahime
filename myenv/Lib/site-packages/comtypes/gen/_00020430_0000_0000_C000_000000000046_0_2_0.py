...
__all__ = [
    'Font', 'OLE_YPOS_PIXELS', 'IFont', 'OLE_XPOS_HIMETRIC',
    'IPicture', 'FontEvents', 'FONTITALIC', 'Unchecked',
    'OLE_YSIZE_HIMETRIC', 'OLE_COLOR', 'OLE_ENABLEDEFAULTBOOL',
    'Default', 'OLE_OPTEXCLUSIVE', 'OLE_XPOS_PIXELS', 'Color',
    'FONTNAME', 'IFontEventsDisp', 'FONTBOLD', 'OLE_YPOS_HIMETRIC',
    'Picture', 'Gray', 'LoadPictureConstants', 'FONTSIZE',
    'OLE_YSIZE_CONTAINER', 'OLE_XSIZE_PIXELS', 'OLE_YSIZE_PIXELS',
    'VgaColor', 'FONTUNDERSCORE', 'OLE_XSIZE_HIMETRIC',
    'OLE_XPOS_CONTAINER', 'OLE_TRISTATE', 'OLE_YPOS_CONTAINER',
    'IPictureDisp', 'StdFont', 'FONTSTRIKETHROUGH', 'OLE_HANDLE',
    'StdPicture', 'Checked', 'OLE_CANCELBOOL', 'IFontDisp',
    'Monochrome', 'OLE_XSIZE_CONTAINER'
]

_check_version('1.1.14', 1679120437.379213)
